...
export interface ApiAttemptAttempt extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    Status: Attribute.Enumeration<
      ['completed', 'not_started', 'in_progress', 'not_passed']
    > &
      Attribute.DefaultTo<'not_started'>;
    AttemptTaskValues: Attribute.Relation<
      'api::attempt.attempt',
      'oneToMany',
      'api::attempt-task-value.attempt-task-value'
    >;
...
export interface ApiAttemptTaskValueAttemptTaskValue
  extends Schema.CollectionType {
...
export interface ApiOrderedTaskThemeOrderedTaskTheme
  extends Schema.CollectionType {
  ...
  attributes: {
    ...
    ExamPosition: Attribute.Integer &
      Attribute.Unique &
      Attribute.SetMinMax<
        {
          min: 1;
        ...
        number
      >;
    slug: Attribute.UID<'api::ordered-task-theme.ordered-task-theme', 'Title'> &
      Attribute.Required;
    BlockColor: Attribute.Enumeration<
      ['GREEN', 'TEAL', 'CYAN', 'BROWN', 'BLACK']
    > &
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::ordered-task-theme.ordered-task-theme',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiSchoolSchool extends Schema.CollectionType {
  ...
  attributes: {
    Name: Attribute.String;
    slug: Attribute.UID<'api::school.school', 'Name'> & Attribute.Required;
...
export interface ApiTaskTask extends Schema.CollectionType {
  ...
  attributes: {
    Theme: Attribute.Relation<
      'api::task.task',
      'oneToOne',
      'api::task-theme.task-theme'
    >;
    Description: Attribute.Blocks;
    Answer: Attribute.String;
    AnswerDescription: Attribute.Blocks;
...
export interface ApiTaskThemeTaskTheme extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::task-theme.task-theme', 'Title'> &
      Attribute.Required;
    Description: Attribute.String;
    OrderedTaskTheme: Attribute.Relation<
      'api::task-theme.task-theme',
      'oneToOne',
      'api::ordered-task-theme.ordered-task-theme'
    >;
...
export interface ApiTestTest extends Schema.CollectionType {
  ...
  attributes: {
    Tasks: Attribute.Relation<'api::test.test', 'oneToMany', 'api::task.task'>;
    MadeBy: Attribute.Relation<
      'api::test.test',
      'oneToOne',
      'plugin::users-permissions.user'
    >;
    AssignedTo: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    CompleteTestBefore: Attribute.DateTime;
    Attempts: Attribute.Relation<
      'api::test.test',
      'oneToMany',
      'api::attempt.attempt'
    >;
    AvailableAttempts: Attribute.Integer &
      Attribute.SetMinMax<
        {
          min: 1;
        },
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::attempt-task-value.attempt-task-value': ApiAttemptTaskValueAttemptTaskValue;
      'api::class.class': ApiClassClass;
      'api::ordered-task-theme.ordered-task-theme': ApiOrderedTaskThemeOrderedTaskTheme;
      'api::school.school': ApiSchoolSchool;
      'api::task.task': ApiTaskTask;
      'api::task-theme.task-theme': ApiTaskThemeTaskTheme;
